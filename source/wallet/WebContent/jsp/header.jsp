...
<body>
	<div>
		<ul class="navigation">
			...
			<li><a class="navlink"
				href="${pageContext.request.contextPath}/card">Card</a></li>
			...
			<li><a class="navlink" href="${pageContext.request.contextPath}/transAnalyze">Transaction analysis</a></li>
	...
	<div style="text-align: right;">
		<img src="LoadImage?filename=logo.jpg" style="height: 80px;">
	</div>
</body>
</html>